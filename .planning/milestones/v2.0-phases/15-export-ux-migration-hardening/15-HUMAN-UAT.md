...
result: passed — usuário escolheu "Apply fix now"; CR-01 corrigido em `fix(15): harden SEC-04 sanitization...` (neutralizadores iniciais removidos antes do teste de gatilho + 6 testes de regressão; suíte 358 verde).
