...
export async function POST(request: Request) {
  ...
  try {
    ...
    const payload = await resolveRegexPayload({ mode: "generate", request: parsed.data, history, attachmentContext });
    ...
    return new Response(createRegexEventStream(payload, quotaCheck.lastFreeUse, attachmentMeta), {
