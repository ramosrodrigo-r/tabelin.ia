...
export async function POST(request: Request) {
  ...
  try {
    ...
    const payload = await resolveScriptPayload({ request: parsed.data, history, attachmentContext });
    ...
    return new Response(createScriptEventStream(payload, quotaCheck.lastFreeUse, attachmentMeta), {
